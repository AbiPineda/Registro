<?php
  ...
  if(isset($_SESSION['id_usuario'])){
    header('location: Controlador/Redireccionar.php');
  }
        ...
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          ...
          <form id="formulario_registro">
            ...
            <fieldset>
              ...
              <label class="sr-only" for="clave">Usuario</label>
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                <input type="text" class="form-control" name="usuario" placeholder="Ingresa nombre de usuario">
              </div>
              ...
              <div class="input-group">
                ...
                <input type="password" autocomplete="off" class="form-control" name="contraseña" placeholder="Digite contraseña">
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-lock"></i></div>
                <input type="password" autocomplete="off" class="form-control" name="contraseña2" placeholder="Verificar contraseña">
              </div>
